    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', '고객'), ('store_owner', '사장님'), ('staff', '직원')], db_comment='고객 유형', default='customer', max_length=16)),
                ...
                ('department', models.ForeignKey(db_comment='소속부서', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.department')),
